...
public class FileGridTest extends AbstractTest implements Util {
    ...
    public void t01() {
        ...
        var grid = builder.buildSync("test-01", (x, y, values) -> Ginsu.first(values));
    ...
    public void t02() {
        ...
        var grid1 = builder1.buildSync("first-element", (x, y, values) -> Ginsu.first(values));
        var grid2 = builder2.buildSync("first-element", (x, y, values) -> Ginsu.first(values));
        ...
        var union = unionBuilder.buildSync("result", (x, y, values) -> (Polygon) CascadedPolygonUnion.union(values), ForkJoinPool.commonPool());
